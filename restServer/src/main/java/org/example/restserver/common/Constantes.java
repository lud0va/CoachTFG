...
public class Constantes {
    ...
    public static final String FECHA_EXP_LICENCIA = "FechaExpLicencia";
    public static final String ALIMENTOS = "alimentos";
    public static final String IDALIMENTOS = "idalimentos";
    ...
    public static final String VITAMINAS = "vitaminas";
    public static final String MINERALES = "minerales";
    ...
    public static final String EL_TOKEN_HA_CADUCADO = "El token  ha caducado.";
